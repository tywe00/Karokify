...
function handleLogin() {
    ...
    generateCodeChallenge(codeVerifier).then(codeChallenge => {
        ...
        let scope = 'user-read-private user-read-email playlist-read-private playlist-read-collaborative streaming user-read-playback-state user-modify-playback-state';
